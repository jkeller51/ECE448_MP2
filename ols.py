#External reference used: code in this module not written by CS 440 team.
#Code was adapted from sci-py cookbook (http://scipy-cookbook.readthedocs.io/items/OLS.html)
#Provides functionality for performing multiple linear regression in python.
